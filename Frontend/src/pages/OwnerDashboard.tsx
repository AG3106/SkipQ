    ...
    <div className="min-h-screen bg-transparent relative overflow-x-hidden">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-3 md:grid-cols-6 gap-3 md:gap-4 mb-6 md:mb-8">
          ...
          <Link to="/wallet">
            <button className="w-full bg-white/80 dark:bg-gray-900/80 hover:bg-white dark:hover:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-5 transition-all hover:shadow-lg hover:-translate-y-1 group">
              <div className="bg-green-50 dark:bg-green-950/30 w-12 h-12 rounded-xl flex items-center justify-center mx-auto mb-3 group-hover:bg-[#D4725C] transition-colors">
                <Wallet className="size-6 text-[#D4725C] group-hover:text-white transition-colors" />
              </div>
              <p className="font-bold text-sm text-gray-700 dark:text-gray-300">Wallet</p>
            </button>
          </Link>
        ...
        <div className="flex gap-2 md:gap-4 mb-6 bg-white/50 dark:bg-gray-900/50 p-1 md:p-1.5 rounded-2xl w-full md:w-fit overflow-x-auto">
          <button
            ...
            className={`px-4 md:px-6 py-2 md:py-2.5 rounded-xl font-bold transition-all text-sm md:text-base whitespace-nowrap flex-1 md:flex-none ${activeTab === "notifications"
          ...
          <button
            ...
            className={`px-4 md:px-6 py-2 md:py-2.5 rounded-xl font-bold transition-all text-sm md:text-base whitespace-nowrap flex-1 md:flex-none ${activeTab === "queue"
              ? "bg-[#D4725C] text-white shadow-md shadow-orange-200 dark:shadow-orange-900/50"
              : "text-gray-600 dark:text-gray-400 hover:bg-white/80 dark:hover:bg-gray-800/80"
              }`}
          >
          ...
          <button
            ...
            className={`px-4 md:px-6 py-2 md:py-2.5 rounded-xl font-bold transition-all text-sm md:text-base whitespace-nowrap flex-1 md:flex-none ${activeTab === "cancellations"
              ? "bg-[#D4725C] text-white shadow-md shadow-orange-200 dark:shadow-orange-900/50"
              : "text-gray-600 dark:text-gray-400 hover:bg-white/80 dark:hover:bg-gray-800/80"
              }`}
          >
          ...
          <button
            ...
            className={`px-4 md:px-6 py-2 md:py-2.5 rounded-xl font-bold transition-all text-sm md:text-base whitespace-nowrap flex-1 md:flex-none ${activeTab === "cakes"
              ? "bg-[#D4725C] text-white shadow-md shadow-orange-200 dark:shadow-orange-900/50"
              : "text-gray-600 dark:text-gray-400 hover:bg-white/80 dark:hover:bg-gray-800/80"
              }`}
          >
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-lg text-sm font-bold ${cakeSubView === "active"
                          ? "bg-[#D4725C] text-white"
                          : "bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400"
                          }`}
                      >
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-lg text-sm font-bold ${cakeSubView === "history"
                          ? "bg-[#D4725C] text-white"
                          : "bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400"
                          }`}
                      >
                        ...
                        sortedCakeDates.map((date) => (
                          <div key={date} className="space-y-3">
                            <div className="flex items-center gap-3">
                              <div className={`px-3 py-1.5 rounded-xl text-xs font-black ${isCakeToday(date) ? "bg-[#D4725C] text-white"
